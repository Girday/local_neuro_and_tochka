...
# 4. Внешние интерфейсы (внутренний API)
...
# 5. Многоступенчатый поиск (основная логика)

## 5.1 Шаг 1. Нормализация запроса
...
## 9.3 Тестирование релевантности
